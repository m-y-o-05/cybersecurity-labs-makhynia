...
2. **Введення повідомлення**
   - У текстове поле введіть секретне повідомлення.
...
3. **Вибір зображення**
   ...
   - Переконайтеся, що зображення достатньо велике для повідомлення.
...
4. **Налаштування шифрування (опціонально)**
   ...
   - Програма автоматично згенерує ключ з персональних даних.
